...
public class AdminUserController extends HttpServlet {
   ...
   private void loadUserList(HttpServletRequest req) {
        ...
        Integer status = (statusStr == null || statusStr.isEmpty()) ? null : Integer.parseInt(statusStr);
        Integer roleId = (roleStr == null || roleStr.isEmpty()) ? null : Integer.parseInt(roleStr);

        try {
            List<User> users = userDAO.findAll(status, roleId, q);
